module pixel_generator_4_old #(
    ...
    output wire [15:0] x_out, // x and y is known between top level and newton core
...
assign x_out = x; //assign x y to output of newton core
assign y_out = y;
...
always @(posedge clk) begin
    if (rst) begin
        ...
        done <= 0;   // default: only pulse done for one clock cycle
        case (state)
            S_INIT: begin
                valid <= 0;
