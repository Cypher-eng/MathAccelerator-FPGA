...
module pixgen_tb;
    ...
    pixel_generator p1 (
        ...
        .debug_iter_valid(debug_iter_valid),
    ...
    p1.regfile[0] = -32'sd8192; // zr0 = -2.0 default -8192
    p1.regfile[1] = -32'sd6144; // zi0 = -1.5 default -6144
    p1.regfile[2] =  32'd26; //zoom - default value is 26 for no zoom
    p1.regfile[3] =  32'd30; //max iterations
    end
